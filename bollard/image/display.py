...
def build_table(
    columns: Sequence[str], data: list[dict], show_header: bool = True
) -> str:
    ...
    table = tabulate(table_spec, data, show_header=show_header)
    return table
...
def print_table(
    ...
    table = build_table(columns, data, show_header)
    click.echo(table)
